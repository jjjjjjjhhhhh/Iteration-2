	...
	<div class="center_view" :style='{}'>
		...
		<div class="usersView">
			...
			<div class="usersBox updateInfo" v-if="tabIndex=='center'">
				<el-form class="usersForm" ref="userFormRef" :model="userForm" label-width="120px" :rules="rules">
					<el-row>
						<el-col :span="12">
							<el-form-item prop="yonghuzhanghao" label="User Account">
								<el-input class="list_inp" v-model="userForm.yonghuzhanghao" placeholder="User Account" readonly></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item prop="yonghuxingming" label="User Name">
								<el-input class="list_inp" v-model="userForm.yonghuxingming" placeholder="User Name" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
							<el-form-item prop="touxiang" label="Icon">
								<uploads
									action="file/upload" 
						...
						<el-col :span="12">
							<el-form-item prop="shoujihaoma" label="phone number">
								<el-input class="list_inp" v-model="userForm.shoujihaoma" placeholder="phone number" ></el-input>
							</el-form-item>
						</el-col>
					</el-row>
			...
			<div class="usersBox updatePassword" v-if="tabIndex=='updatePassword'">
				<el-form class="usersForm" ref="passwordFormRef" :model="passwordForm" label-width="120px"
					...
					<el-row>
						...
						<el-col :span="12">
							<el-form-item label="Password" prop="newmima">
								<el-input class="list_inp" v-model="passwordForm.newmima" placeholder="Password"
									type="password"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
		...
		<el-dialog v-model="chatVisible" @close="clearChat" :title="nowname">
			...
			<div slot="footer" class="dialog-footer">
				<el-input @keydown.enter.native="addChat" v-model="chatForm.content" placeholder="Please enter the content" style="width: calc(100% - 180px);float: left;border: 1px solid #ccc;margin-right: 10px;">
				</el-input>
				<el-button :disabled="chatForm.content?false:true" type="primary" @click="addChat">sending</el-button>
